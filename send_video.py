...
def handleLinux(deviceNumber, videoPort):
    ...
    commandLine = '/usr/local/bin/ffmpeg -s 640x480 -f video4linux2 -i /dev/video%s -f mpeg1video -b 600k -r 20 http://%s:%s/hello/640/480/' % (deviceAnswer, server, videoPort) # ClawDaddy
