...
parser.add_argument('--slow-for-low_battery', dest='slow_for_low_battery', action='store_true')
parser.set_defaults(slow_for_low_battery=False)
parser.add_argument('--reverse-ssh-key_file', default='/home/pi/reverse_ssh_key1.pem')
